...
import com.isfan17.freshnews.databinding.ItemArticleListBinding
import com.isfan17.freshnews.helper.DateFormatter

class ArticleListAdapter(private val onItemClicked: (Article) -> Unit): ListAdapter<Article, ArticleListAdapter.ArticleViewHolder>(DiffCallback) {

    inner class ArticleViewHolder(private var binding: ItemArticleListBinding) : RecyclerView.ViewHolder(binding.root) {
